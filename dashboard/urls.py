...
urlpatterns = [
    ...
    path(
        ...
        FacturasPorProveedorView.as_view(),
        name="facturas_proveedores",
    ),
    path(
        "facturas/proveedores/importar/",
        ImportarFacturasProveedoresCSV.as_view(),
        name="importar_facturas_proveedores",
    ),
    ...
    path(
        ...
        FacturasVencidasCountView.as_view(),
